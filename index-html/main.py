...
attack_stat = st.sidebar.slider("こうげき/とくこう", 1, 300, 150)
defense_stat = st.sidebar.slider("ぼうぎょ/とくぼう", 1, 300, 150)
...
damage = int((((2 * level / 5 + 2) * power * attack_stat / defense_stat) / 50 + 2) * (1.5 if attack_type == move_type else 1) )
